      ...
      <div :class="['filter-content', { 'is-collapsed': isFilterCollapsed }]">
        <div class="filter-container">
          ...
          <div class="filter-group category-group">
            <select :value="selectedCategories[0] || ''" @change="toggleCategory($event.target.value)"
          ...
          <div class="filter-group keyword-group">
            <div class="input-icon-wrapper">
              ...
              <input type="text" v-model="searchQuery" placeholder="Search by Title, Author, or Keyword"
                class="filter-input" />
            </div>
          </div>
          ...
          <div class="filter-group view-group">
            <div class="view-toggles">
              <button :class="['view-toggle-btn', { active: viewMode === 'grid' }]" @click="viewMode = 'grid'"
